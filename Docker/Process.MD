...
so now we created two stages in Docker file :
  Stage 1 → Node exists

  Stage 2 → Node is gone

  Final image = only Nginx + static files
...
# To check it is pushed and working 
  docker images | findstr react-app
# Run
...
This is the process:
 ...
 # C:\Users\amit\Documents\GitHub\Docker-Syntax\Docker\react-app>docker ps
CONTAINER ID   IMAGE            COMMAND                  CREATED          STATUS          PORTS                                     NAMES
9596a5c66f07   react-app:prod   "/docker-entrypoint.…"   35 seconds ago   Up 35 seconds   0.0.0.0:8080->80/tcp, [::]:8080->80/tcp   ecstatic_meninsky


# C:\Users\amit\Documents\GitHub\Docker-Syntax\Docker\react-app>docker exec -it 9596a5c66f07 sh
/ # nginx -v
...
docker exec -it 9596a5c66f07 sh --> to enter into container 
nginx -v --> will show the nginx vershion 
node -v --> now it should see not found 
exit --> exit the shell 


# Over view what does Docker do and care of 
...
docker tag nikhilsingh45/react-app:2.0 nikhilsingh45/react-app:2.1

 docker tag nikhilsingh45/react-app:2.0 nikhilsingh45/react-app:2.1 

 check uplode history 
 docker history nikhilsingh45/react-app:1.1

 
   docker images | findstr react-app

 C:\Users\amit\Documents\GitHub\Docker-Syntax\Docker\react-app>docker images | findstr react-app
nikhilsingh45/react-app     2.1              00106a033e79   11 minutes ago      92.5MB
react-app                   prod             33ea42d54133   About an hour ago   92.5MB
react-app                   1.0              cca7bd6c6e5f   24 hours ago        516MB
nikhilsingh45/react-app     1.0              cca7bd6c6e5f   24 hours ago        516MB
nikhilsingh45/react-app     2.0              cca7bd6c6e5f   24 hours ago        516MB

C:\Users\amit\Documents\GitHub\Docker-Syntax\Docker\react-app>docker run -p 8080:80 nikhilsingh45/react-app:2.1  

## Key take aways 

 | Statement                    | Correct?              |
| ---------------------------- | --------------------- |
| Pulled image is not editable | ✅ Yes                 |
| User cannot push changes     | ✅ Yes                 |
| Prod image hides source      | ✅ Yes (compiled only) |
| Dev image hides source       | ❌ No                  |
| Private Git repo exposed     | ❌ No                  |
| Docker image = package       | ✅ Good analogy        |



docker info

Entering in to container 

docker exec -it 7c65c8fa6251 sh
ls


# A mental map of hosting Paraller Containers 
